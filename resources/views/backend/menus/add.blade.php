        ...
        <div class="content">
            <form method="POST" action="{{ url('backend/menus/save') }}">
                ...
                <div class="columns">
                    <div class="column">
                        <div class="field">
                            <label class="label">Link (URI)</label>
                            <div class="control">
                            ...
                            <div class="control">
                                <div class="select full-width">
                                    <select class="full-width" name="link_type">
                                        <option value="{{ \App\Models\Menu::TYPE_STATIC_CONTENT }}">Link to static content page</option>
                                        <option value="{{ \App\Models\Menu::TYPE_DYNAMIC_CONTENT }}">Link to dynamic content</option>
                                    </select>
                                </div>
                            </div>
                        </div>
